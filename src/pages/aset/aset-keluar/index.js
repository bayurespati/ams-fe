...
import TableHeader from 'src/views/apps/asetKeluar/TableHeader'
...
const defaultColumns = [
  ...
  },
  {
    ...
    renderCell: ({ row }) => <Typography sx={{ color: 'text.secondary' }}>{row.tgl_masuk}</Typography>
  },
  {
    flex: 0.15,
    minWidth: 190,
  ...
  },
  {
    ...
    headerClassName: 'super-app-theme--header',
    headerName: 'Tgl Pengembalian',
    renderCell: ({ row }) => <Typography sx={{ color: 'text.secondary' }}>{row.tgl_pengembalian}</Typography>
  },
  {
    flex: 0.15,
    minWidth: 190,
  ...
  return (
    <>
      <Grid container spacing={6}>
        <Grid item xs={12}>
          <Card>
            <CardHeader title='Daftar Aset Keluar (DO Out)' />
...
export default AsetKeluarTable
