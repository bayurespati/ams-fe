    ...
    <>
      ...
      <Dialog fullWidth maxWidth='sm' onClose={handleDialogToggle} open={open}>
        ...
        >
          ...
          >
            <CustomTextField fullWidth sx={{ mb: 5 }} label='Nama Aset' placeholder='Masukkan Nama Aset' />
            <CustomTextField fullWidth sx={{ mb: 5 }} label='Alias' placeholder='Masukkan Kode Alias' />
